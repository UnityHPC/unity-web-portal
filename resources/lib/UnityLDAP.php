...
class UnityLDAP extends ldapConn
{
  ...
  const ORG_ID_MAP = array(20000, 29999);
  ...
  public function __construct($host, $dn, $pass, $custom_user_mappings, $user_ou, $group_ou, $pigroup_ou, $orggroup_ou, $admin_group, $def_user_shell)
  {
